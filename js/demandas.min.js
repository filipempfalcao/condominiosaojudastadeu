document.addEventListener('DOMContentLoaded', function() {
    ...
    function renderizarDemandas() {
        ...
        const criticidadeSelecionada = criticidadeFilter.value;
        ...
        const demandasFiltradas = demandas.filter(demanda => {
            ...
            if (criticidadeSelecionada && demanda.criticidade !== criticidadeSelecionada) {
                return false;
            }
    ...
    function renderizarPaginacao(totalPaginas) {
        ...
        btnAnterior.className = 'btn btn-sm';
        ...
        for (let i = 1; i <= totalPaginas; i++) {
            ...
            btnPagina.className = i === paginaAtual ? 'btn btn-sm active' : 'btn btn-sm';
        ...
        btnProxima.className = 'btn btn-sm';
    ...
    criticidadeFilter.addEventListener('change', () => {
        paginaAtual = 1;
        renderizarDemandas();
    });
